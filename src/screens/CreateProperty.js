      ...
      <div className="">
        ...
        <form className="mt-10">
          <div className="flex justify-around w-30 mb-2">
            <label
              htmlFor="title"
              className="text-gray-500 mb-2 flex flex-col items-center font-semibold"
            >
              Title
              <input
                type="text"
            ...
            <label
              htmlFor="location"
              className="mb-2 text-gray-500 flex flex-col items-center font-semibold"
            >
              Location
              <input
                type="text"
          ...
          <div className="flex justify-around mb-5">
            <label className="mb-2 text-gray-500 flex items-center gap-3 font-semibold">
              ...
              <select
                name="propertyType"
                className="outline-none text-black font-normal rounded-lg border "
              >
          ...
          <div className="flex justify-around gap-28 mt-12 ">
            <label
              htmlFor="description"
              className="mb-2 text-gray-500 flex flex-col font-semibold items-center"
            >
              Description
              <textarea
                name="description"
          ...
          <div className="text-right mt-5">
            <button
              type="submit"
              className="  border border-amber-400 justify-center font-bold text-amber-400 hover:bg-amber-400 hover:text-white px-4 py-2 rounded-lg"
            >
              Submit
            </button>
          </div>
