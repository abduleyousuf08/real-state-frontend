  ...
  return (
    <div>
      <div className="card-component-section-two">
        <div class="max-w-ms bg-white border border-gray-200 rounded-lg shadow  dark:border-gray-700 card-component-flowbite">
          <a href="#">
            <img
              class="rounded-t-lg"
              src={sale.image}
          ...
          <div class="p-5">
            ...
            <p class="mb-3 font-normal card-text-flowbite-desc ">{sale.desc}</p>
            {/**property infos */}
            ...
            <a
              href="#"
              class="inline-flex items-center px-3 py-2 text-sm font-medium text-center text-white bg-blue-700 rounded-lg  focus:ring-4 focus:outline-none    card-btn"
            >
              Read more
              <svg
                aria-hidden="true"
