...
function ChatBox() {
    ...
    return (
        <main className='h-full'>
            {recipientUser ? (
                <div className='bg-gray-100 border rounded-tr-lg rounded-br-lg shadow-[rgba(13,_38,_76,_0.19)_0px_9px_20px]'>
                    <div className='w-full'>
                        ...
                        {/* Chat Body */}
                        <div className='flex flex-col gap-5 p-6 overflow-y-auto h-96 scrollbar-hide' >
                    ...
                    <div className='flex bg-white p-1.5 rounded-br-lg'>
                        <label for='file-upload' className='inline-block hover:bg-cyan-900 rounded-full cursor-pointer h-6 mt-3 '>
                ...
                <div  className='bg-gray-100 border  shadow-[rgba(13,_38,_76,_0.19)_0px_9px_20px] flex flex-col items-center relative h-full'>
                    <span className='mt-10 text-xl font-bold absolute text-cyan-900'>Tap on a chat to start conversation...</span>
                    <img
                        src={chat}
                        alt='startChat'
