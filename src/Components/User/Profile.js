...
function Profile() {
  const { user, editProfile, updateProfile, updateUserProfile } =
        ...
        <div className="flex p-10 mt-10 gap-10 ml-16">
          ...
          <div className="mt-4 flex flex-col gap-5">
            <div className="flex flex-col">
              ...
              {isEditing ? (
                <input
                  className="border rounded-lg outline-none border-cyan-900"
                  type="text"
                  onChange={(e) =>
                    updateUserProfile({
                      ...updateProfile,
            ...
            <div className="flex flex-col">
              ...
              {isEditing ? (
                <input
                  className="border border-cyan-900 outline-none rounded-lg"
                  type="tel"
                  onChange={(e) =>
                    updateUserProfile({
                      ...updateProfile,
            ...
            <div className="flex flex-col">
              ...
              {isEditing ? (
                <input
                  className="border rounded-lg border-cyan-900 outline-none"
                  type="text"
                  onChange={(e) =>
                    updateUserProfile({
                      ...updateProfile,
            ...
            {isEditing ? (
              <button
                className="mt-5 flex items-center gap-2 border rounded-md p-2 border-amber-400  justify-center font-bold text-amber-400 hover:bg-amber-400 hover:text-white"
              ...
              >
                <MdModeEditOutline className="fill-current" />
                Edit Profile
              </button>
            )}
          </div>
