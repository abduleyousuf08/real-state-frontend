  ...
  return (
    <div className="w-full">
      {isHomepage && isUserSignedIn ? (
        ...
        <div className="">
          <div className="absolute w-full text-white font-bold">
          ...
          <div className="flex items-center justify-around mr-20 text-white font-bold">
            ...
            <div className="flex items-center gap-5">
              <RouterLink to={"/auth"}>
                <button
                  style={{ order: 2 }}
                  className="flex items-center gap-2 shadow-xl rounded-lg h-9 px-2 py-2 bg-white text-black font-medium border-black ml-20 cursor-pointer hover:bg-amber-400 "
                >
                  <BiUserCheck /> Sign in
                </button>
              </RouterLink>
              <RouterLink to={"/submitProperty"}>
                <button className="flex items-center gap-2 hover:bg-amber-400 hover:text-black shadow-xl   py-2 px-4 rounded-lg bg-black text-white  cursor-pointer ">
